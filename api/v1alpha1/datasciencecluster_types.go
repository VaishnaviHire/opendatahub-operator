...
type DashboardControllers struct {
	DashboardController `json:"dashboardController,omitempty"`
}
type Training struct {
	Component   `json:""`
	Controllers TrainingControllers `json:"controllers,omitempty"`
}

type Serving struct {
	Component     `json:""`
	Controllers   ServingControllers `json:"controllers,omitempty"`
	TestConfigMap v1.ConfigMap       `json:"testConfigMap,omitempty"`
}
...
type TrainingControllers struct {
	DataSciencePipelinesController `json:"dataSciencePipelinesController"`
	CodeflareController            `json:"codeflareController"`
}

type DataSciencePipelinesController struct {
	Controller `json:""`
}

type CodeflareController struct {
	Controller `json:""`
}
